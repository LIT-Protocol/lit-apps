...
export default function SessionPage() {
  ...
  const session = pkpWalletConnect.getActiveSessions()[topic]
  ...
  async function onSessionPing() {
    setLoading(true)
    await pkpWalletConnect.getSignClient().ping({ topic })
    setLoading(false)
  }
  ...
  async function onSessionEmit() {
    setLoading(true)
    console.log('baleg')
    await pkpWalletConnect.emitSessionEvent({
      topic,
  ...
  //   setLoading(true)
  //   await pkpWalletConnect.updateSession({ topic, namespaces: newNs })
  //   setUpdated(new Date())
  //   setLoading(false)
  // }
