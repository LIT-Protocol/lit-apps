...
export function usePKPs(props) {
    ...
    var defaultRender = function (callback) {
        ...
        return (React.createElement("div", { style: { width: "100%" } },
            React.createElement("table", { style: { width: "100%", textAlign: "left", padding: "12px" } }, data.map(function (pkp, index) { return (React.createElement(React.Fragment, { key: index },
                React.createElement("tbody", { onClick: function () { return callback(pkp); } },
                    React.createElement("tr", null,
                        React.createElement("th", null, "#"),
                        React.createElement("td", null, index + 1)),
                    React.createElement("tr", null,
                        React.createElement("th", null, "Token ID"),
                        React.createElement("td", null, pkp.tokenId)),
                    React.createElement("tr", null,
                        React.createElement("th", null, "Public Key"),
                        React.createElement("td", null, pkp.publicKey)),
                    React.createElement("tr", null,
                        React.createElement("th", null, "BTC Address"),
                        React.createElement("td", null, pkp.btcAddress)),
                    React.createElement("tr", null,
                        React.createElement("th", null, "ETH Address"),
                        React.createElement("td", null, pkp.ethAddress)),
                    React.createElement("tr", null,
                        React.createElement("th", null, "Cosmos Address"),
                        React.createElement("td", null, pkp.cosmosAddress))))); }))));
    };
