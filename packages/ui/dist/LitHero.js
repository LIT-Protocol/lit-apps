...
export var LitHero = function (prop) {
    var defaultClass = "lit-hero";
    ...
    return (_jsxs("section", __assign({}, newProp, { children: [_jsx("h1", { children: newProp.title }), _jsx("p", { children: newProp.description })] })));
};
